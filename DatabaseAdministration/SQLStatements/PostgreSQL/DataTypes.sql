...
--Intervals with Dates and Timestamps
SELECT
	('NOV-20-1980 01:23 AM EST' :: TIMESTAMP WITH TIME ZONE)
	-
	('1 D'::INTERVAL);
--"1980-11-19 08:23:00+02"

SELECT
	('NOV-20-1980 01:23 AM EST' :: TIMESTAMP WITH TIME ZONE)
	-
	('4 D'::INTERVAL);
--"1980-11-16 08:23:00+02"

--Calculating Time Differences
SELECT
	('NOV-20-1980 01:23 AM EST' :: TIMESTAMP WITH TIME ZONE)
	-
	('NOV-10-1980 01:23 AM EST' :: TIMESTAMP WITH TIME ZONE);
--"10 days"

SELECT
	('NOV-20-1980 01:23 AM EST' :: TIMESTAMP WITH TIME ZONE)
	-
	('NOV-10-1980 05:43 AM PST' :: TIMESTAMP WITH TIME ZONE);
--"9 days 16:40:00"
